...
1. 터미널에 다음과 같이 입력하여 react-icons 라이브러리 다운로드
npm install react-icons --save
2. 사용하고 싶은 아이콘을 import 한다.
import { 아이콘명1, 아이콘명2 } from "react-icons/아이콘카테고리명"
예를 들어, fontAwesome에 있는 아이콘을 이용하려면, react-icons/fa라고 입력하면 된다.
3. 컴포넌트 마냥 사용하면 된다.
<FaSearch />
*/
